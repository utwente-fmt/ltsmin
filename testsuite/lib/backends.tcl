...
# internal and BuDDy
dict set backends sym params "--vset=" {ldd fdd ldd64 "sylvan --sylvan-bits=32 --sylvan-tablesize=20 --sylvan-maxtablesize=20 --sylvan-cachesize=20 --sylvan-maxcachesize=20" "lddmc --lddmc-tablesize=20 --lddmc-maxtablesize=20 --lddmc-cachesize=20 --lddmc-maxcachesize=20"}

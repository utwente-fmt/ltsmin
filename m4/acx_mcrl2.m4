...
AC_ARG_VAR([MCRL2], [mCRL2 command])
case "$with_mcrl2" in
  no) acx_mcrl2=no ;;
...
if test x"$acx_mcrl2" = xyes; then
    AC_SUBST(MCRL2_CPPFLAGS, ["$MCRL2_CPPFLAGS -I$with_mcrl2/include -I$with_mcrl2/include/mcrl2/aterm"])

...
/**
\brief Create a segment by loading it from the given input.
*/
extern seg_lts_t SLTSloadSegment(lts_input_t input,task_queue_t task_queue);
...
*/
extern task_queue_t SLTSgetQueue(seg_lts_t lts);
...
/**
\brief Enumerate edges
*/
extern void SLTSenum(seg_lts_t lts,lts_enum_cb_t output_handle);

...
struct poptOption options[] = {
    ...
    { "local" , 0 , POPT_ARG_INT | POPT_ARGFLAG_OPTIONAL , &local , 1 , "Use local group exploration to learn transition relations." , NULL },
    ...
    { "sweep", 0, POPT_ARG_STRING, &sweep, 0, "Sweepline method", NULL },

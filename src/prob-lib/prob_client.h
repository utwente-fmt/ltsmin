...
extern State* prob_next_state(prob_client_t pc, State s, char *transitiongroup, int *size);
...
extern InitialResponse prob_init(prob_client_t pc);

extern void print_matrix(const Matrix m);
